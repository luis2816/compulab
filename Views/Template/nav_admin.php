      ...
      <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/dashboard">
                ...
                <span class="app-menu__label">Dashboar</span>
            </a>
        </li>
        <?php } ?>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/sedes">
        ...
        <li class="treeview">
            <a class="app-menu__item" href="#" data-toggle="treeview">
                ...
                <span class="app-menu__label">Bodega</span>
                <i class="treeview-indicator fa fa-angle-right"></i>
            </a>
            <ul class="treeview-menu">

            <?php if(!empty($_SESSION['permisos'][5]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/tipoproductos"><i class="icon fa fa-circle-o"></i> Tipo Productos</a></li>
                <?php } ?>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/stock">
                <i class="app-menu__icon fa fa-shopping-cart" aria-hidden="true"></i>
